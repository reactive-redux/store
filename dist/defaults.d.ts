...
export declare function getDefaults<State, ActionsUnion extends IAction>(config: StoreConfig<State, ActionsUnion> | undefined, options: StoreOptions | undefined, dispatchSubject: Subject<ActionsUnion>): {
