...
/**
     ...
     *  }
     */
constructor(e,a){this.config=e,this.options=a,this._dispatch$=new t.Subject,this.dispatch=e=>{this._dispatch$.next(e)};const{reducer$:i,actions$:f,actionStream$:l,middleware$:h,initialState$:d,destroy$:$,flattenState$:m,shareReplayConfig:x}=function(e={},a={},i){const c=e&&e.reducer$&&e.reducer$.pipe(o)||t.of((e,t)=>e),f=new t.Subject,l=(e&&e.initialState$&&e.initialState$.pipe(o)||t.of({})).pipe(r.share()),h=e&&e.middleware$&&e.middleware$.pipe(o)||t.of([]),d=e&&e.destroy$&&e.destroy$.pipe(o)||t.NEVER,$=u[a&&a.actionFlatOp||exports.FlattenOperator.concatMap],m=u[a&&a.stateFlatOp||exports.FlattenOperator.switchMap],x=a&&a.bufferSize||1,S=a&&a.windowTime;return{reducer$:c,actions$:f,actionStream$:a=>t.merge(e&&e.actionStream$&&e.actionStream$.pipe(o)||t.EMPTY,i).pipe(r.filter(p),r.map(n),$(s),r.tap(f),a,r.map(n)),initialState$:l,middleware$:h,destroy$:d,flattenState$:e=>e.pipe(m(s),r.map(n),m(s)),shareReplayConfig:{refCount:!1,bufferSize:x,windowTime:S}}}(this.config,this.options,this._dispatch$);this.state$=t.combineLatest(d,i,h).pipe(r.map(c),r.concatMap(l),r.startWith(d),m,r.takeUntil($),r.shareReplay(x)),this.state$.subscribe(),this.actions$=f.pipe(r.shareReplay(x))}}Object.keys(a).forEach((function(e){"default"!==e&&Object.defineProperty(exports,e,{enumerable:!0,get:function(){return a[e]}})})),Object.keys(i).forEach((function(e){"default"!==e&&Object.defineProperty(exports,e,{enumerable:!0,get:function(){return i[e]}})})),exports.Store=f,exports.catchErr=o,exports.createStore=function(e={},t={}){return new f(e,t)}
/**
 *
