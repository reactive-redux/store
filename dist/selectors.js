...
exports.isArgumentsChanged = isArgumentsChanged;
...
function select(pathOrMapFn, propsOrPath) {
    ...
    return function selectOperator(source$) {
        ...
        if (typeof pathOrMapFn === 'string') {
            ...
            mapped$ = source$.pipe(operators_1.pluck.apply(void 0, __spread([pathOrMapFn], pathSlices)));
        }
        else if (typeof pathOrMapFn === 'function') {
            mapped$ = source$.pipe(operators_1.map(function (source) { return pathOrMapFn(source, propsOrPath); }));
        }
        else {
...
function ofType() {
    ...
    return operators_1.filter(function (action) {
